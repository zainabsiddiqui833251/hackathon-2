...
const Ourblogs = () => {
    return (
        <section className='lg:h-[900px] h-auto capitalize mb-5'>
            ...
            <div className='flex justify-center flex-wrap gap-6 items-center text-center mt-20'>
                <div className='w-[300px] lg:w-[393px] h-auto lg:h-[553px]'>
                    <div className='w-[300px] lg:w-[393px] h-[393px] mb-3'>
                    ...
                    <h3 className='text-[24px] font-medium border-b-2 border-black w-[130px] h-[46px] m-auto my-6'> <Link href='/blogs'>Read More</Link></h3>
