...
const Contact = () => {
    return (
        <main>
            ...
            <div className='mt-28 lg:w-[644px] w-screen p-5 lg:p-0 m-auto text-center capitalize'>
            ...
            <div className='flex flex-wrap justify-center gap-20'>
                <div className=' w-screen lg:w-[393px] p-5 lg:p-24 capitalize text-lg lg:text-[16px]'>
                    <div className='flex justify-between items-center gap-6 mb-8'>
                        <i className='bi bi-geo-alt-fill text-3xl lg:text-[25px]'></i>
                        <div>
                            <h3 className='text-xl lg:text-[24px] font-medium'>address</h3>
                            <p>236 5th SE Avenue, New York NY10000, United States</p>
                        </div>
                    </div>

                    <div className='flex justify-between items-center gap-6 mb-8'>
                        <i className='bi bi-telephone-fill text-3xl lg:text-[25px]'></i>
                        <div>
                            <h3 className='text-xl lg:text-[24px] font-medium w-[212px]'>phone</h3>
                    ...
                    <div className='flex justify-between items-center gap-6 '>
                        <i className='bi bi-clock-fill text-3xl lg:text-[25px]'></i>
                        <div>
                            <h3 className='text-xl lg:text-[24px] font-medium w-[212px]'>working time</h3>
                ...
                <div className='lg:w-[635px] w-screen p-5 lg:py-16'>
                    <form action="post">
                        <label htmlFor="name">
                            <p className='mb-4 text-[16px] capitalize font-medium'>your name</p>
                            <input type="text" id="name" name="name" required placeholder='Abc' className='w-[300px] lg:w-[527px] mb-4 h-[75px] p-6 border rounded-lg' />
                        </label>

                        <label htmlFor="email">
                            <p className='mb-4 text-[16px] capitalize font-medium'>email address</p>
                            <input type="email" id="email" name="email" placeholder='Abc@def.com' required className='w-[300px] lg:w-[527px] mb-4 h-[75px] p-6 border rounded-lg' />
                        </label>

                        <label htmlFor="subject">
                            <p className='mb-4 text-[16px] capitalize font-medium'>subject</p>
                            <input type="text" id="subject" name="subject" placeholder='This is optional' className='w-[300px] lg:w-[527px] mb-4 h-[75px] p-6 border rounded-lg' />
                        </label>

                        <label htmlFor="message">
                            <p className='mb-4 text-[16px] capitalize font-medium'>message</p>
                            <textarea id="message" name="message" required placeholder="Hi! I&apos;d like to ask about " className='w-[300px] lg:w-[527px] mb-4 h-[120px] p-6 border rounded-lg' rows={4}></textarea>
                        </label>
